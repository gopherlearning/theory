...
// Легковес — это структурный паттерн проектирования, который хранит общее состояние объектов вместо его определения в каждом объекте. В основном этот паттерн используется для экономии памяти.
// Паттерн Легковес можно применять, когда выполняются условия:
// большое количество однообразных объектов и, как следствие, большой расход оперативной памяти;
// часть состояния объектов можно вынести вовне и заменить множество объектов набором разделяемых объектов.
