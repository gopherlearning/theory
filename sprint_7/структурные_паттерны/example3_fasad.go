...
// Фасад — это структурный паттерн, который добавляет простой интерфейс к сложной системе для взаимодействия с ней. Например, когда вы заказываете пиццу, вы не углубляетесь в процесс приготовления и доставки, а о многих других действиях в цепочке производства даже не задумываетесь.
